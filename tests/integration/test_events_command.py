...
def _seed_leadership_setup(guild_id: int = TEST_GUILD_ID) -> "config.GuildConfig":  # noqa: F821 (forward-ref to the function-local `import config`)
    import config
