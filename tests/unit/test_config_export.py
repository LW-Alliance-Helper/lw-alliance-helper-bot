...
class TestCollectGrowth:
    ...
    def test_carries_breakdown_fields(self, seeded_db):
        ...
        save_growth_breakdown_config(
            ...
            breakdown_thresholds={"increased": 25, "steady": 12,
                                  "low": 5, "none": 0},
...
class TestDiscoverRemapGroups:
                ...
                "core": {
                    ...
                    "remap_channels": [
                        {"field": "leadership_channel_id",
                         ...
                         "source_id": 100, "source_name": "#leadership"},
                ...
                "train": {
                    ...
                    "remap_channels": [
                        {"field": "reminder_channel_id",
                         ...
                         "source_id": 200, "source_name": "#train"},
                    ],
                    "remap_roles": [],
                },
            },
    ...
    def test_handles_multi_row_categories(self):
        ...
        parsed = {
            ...
            "data": {
                "events": [
                    {"travels": {}, "remap_channels": [
                        {"field": "draft_channel_id", "purpose": "Event 'A' draft",
                         "source_id": 300, "source_name": "#a"},
                    ], "remap_roles": []},
                    {"travels": {}, "remap_channels": [
                        {"field": "draft_channel_id", "purpose": "Event 'B' draft",
                         "source_id": 300, "source_name": "#a"},
                    ], "remap_roles": []},
                ],
            },
        ...
        assert sorted(channel_groups[0].purposes) == \
               ["Event 'A' draft", "Event 'B' draft"]
...
class TestApplyImportSpreadsheetId:
        ...
        parsed = {
            ...
            "data": {
                "core": {
                    ...
                    "remap_channels": [], "remap_roles": [],
                },
            },
        }
        decisions = config_export.RemapDecisions(
            channel_decisions={}, role_decisions={},
            spreadsheet_id=None, same_guild=False,
        )
        config_export.apply_import(TEST_GUILD_ID, parsed, decisions)
    ...
    def test_explicit_value_writes_through(self, seeded_db):
        ...
        decisions = config_export.RemapDecisions(
            channel_decisions={}, role_decisions={},
            spreadsheet_id="brand-new-id", same_guild=False,
        )
        config_export.apply_import(TEST_GUILD_ID, parsed, decisions)
    ...
    def test_empty_string_clears(self, seeded_db):
        ...
        decisions = config_export.RemapDecisions(
            channel_decisions={}, role_decisions={},
            spreadsheet_id="", same_guild=False,
        )
        config_export.apply_import(TEST_GUILD_ID, parsed, decisions)
