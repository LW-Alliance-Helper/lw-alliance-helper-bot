...
def test_admin_group_registers_globally_when_env_unset(monkeypatch):
    ...
    overview / guild_info / forget_guild / shiny_servers subcommands)
    fall back to global registration (local-dev affordance)."""
    ...
    assert sub_names == {"overview", "guild_info", "forget_guild", "shiny_servers"}
